...
test('DualFuel test', async ({ page }) => {
    ...
    const fixMeterCategory:string[] = [ '1 Year Fixed Loyalty', '1 Year Fixed Loyalty Economy 7', '1 Year Fixed Economy 7', '1 Year Fixed + Boiler Cover',
        '1 Year Fixed + Boiler Cover Economy 7', '1 Year Fixed + Greener Electricity', '1 Year Fixed + Greener Electricity Economy 7', '1 Year Fixed',];
    ...
    for (const property in dualFuelBucket) {
        ...
        if (zoneBasedPriceData.length) {
            ...
            console.log(eleTariffName);
            if (eleTariffName === 'Simpler Energy' || eleTariffName === 'Warmer Home Plan' || eleTariffName === 'Pay As You Go') { eleTariffName = 'Standard'; }

            else {
                fixMeterCategory.forEach((element) => {

                    if (element === eleTariffName && element.length === eleTariffName.length) {
            ...
            console.log('Meter selected is ' + eMeter);
